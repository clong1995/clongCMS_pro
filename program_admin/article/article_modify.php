...
<head>
    <title>修改文章</title>
    <link type="text/css" rel="stylesheet" href="<?= $PRI_RES ?>/css/article_modify.css"/>
</head>
<body>
<div class="center">
    <h1 class="table-title">☸ 修改文章</h1>
    <table class="table" cellspacing="0">
        <tr>
            <td class="tdRight">标题：</td>
            <td class="tdLeft">
                <input class="title" type="text" value="" id="title" placeholder="填写文章标题"/>
                <input type="hidden" id="aid" value="<?=$RArr[1]?>">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="tdCenter">
                <input class="btn-submit" id="btnSubmit" type="button" value="提交修改">
...
<script type="text/javascript" src="<?= $PRI_RES ?>/js/article_modify.js"></script>
</body>